        ...
        <div className="text-center">
          <h1 className="mt-5 mb-5 text-3xl font-bold">Welcome {user.displayName} {user.email}!</h1>
            <div className="mt-5 mb-5">
                <Link className="bg-orange-500 hover:bg-orange-300 p-2 m-2 w-28 rounded-md text-md font-bold text-white text-center drop-shadow-md" href="/week10/shopping-list">Shopping List</Link>
            </div>
